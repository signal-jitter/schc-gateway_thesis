...
ICMP field definitions implemented
'''
...
class Decompressor:
    ...
    def __init__( self, RM ):
        ...
        self.field_size = {
            ...
            "ICMPV6.TYPE": [8, "direct"],
            "ICMPV6.CODE": [8, "direct"],
            "ICMPV6.CKSUM": [16, "direct"],
            "ICMPV6.IDENT": [16, "direct"],
            "ICMPV6.SEQNO": [16, "direct"]
        }
    ...
    def DA_valueSent( self, buf, headers, TV, length, nature, arg, algo ):
        print ( "DA_valueSent", TV, length, nature, arg, algo )
        if ( nature == "variable" ):
            leng = 0
            for i in range ( 0, 4 ):
                leng <<= 1
